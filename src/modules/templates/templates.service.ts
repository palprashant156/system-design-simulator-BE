  ...
  private async seedBuiltInTemplates() {
    const templates = [
      ...
      },
      {
        ...
        description: 'Global video distribution with high read-throughput, CDNs, and transcoding pipeline.',
        category: 'Streaming',
        nodes: [
          { id: 'node-1', type: 'cdn', label: 'Video CDN', positionX: 100, positionY: 100, data: {} },
          { id: 'node-2', type: 'api-gateway', label: 'API Gateway', positionX: 300, positionY: 200, data: {} },
          { id: 'node-3', type: 'load-balancer', label: 'Load Balancer', positionX: 500, positionY: 200, data: {} },
          { id: 'node-4', type: 'microservice', label: 'Video Upload Service', positionX: 750, positionY: 100, data: {} },
          { id: 'node-5', type: 'search-service', label: 'Search & Recommend', positionX: 750, positionY: 300, data: {} },
          { id: 'node-6', type: 'object-storage', label: 'S3 Video Storage', positionX: 1000, positionY: 50, data: {} },
          { id: 'node-7', type: 'postgresql', label: 'Metadata DB', positionX: 1000, positionY: 200, data: {} },
          { id: 'node-8', type: 'redis', label: 'Recommendations Cache', positionX: 1000, positionY: 350, data: {} },
        ],
        edges: [
          { id: 'edge-1', source: 'node-1', target: 'node-2', label: 'HTTPS' },
      ...
      },
      {
        ...
        description: 'Real-time messaging using WebSockets, Erlang backend, and Mnesia for presence and metadata.',
        category: 'Messaging',
        nodes: [
          { id: 'node-1', type: 'api-gateway', label: 'WebSocket Gateway', positionX: 100, positionY: 200, data: {} },
          { id: 'node-2', type: 'microservice', label: 'Chat Service', positionX: 350, positionY: 200, data: {} },
          { id: 'node-3', type: 'microservice', label: 'Group Service', positionX: 350, positionY: 350, data: {} },
          { id: 'node-4', type: 'redis', label: 'Presence Cache', positionX: 600, positionY: 100, data: {} },
          { id: 'node-5', type: 'database', label: 'Mnesia DB', positionX: 600, positionY: 250, data: {} },
          { id: 'node-6', type: 'object-storage', label: 'Media Blob Storage', positionX: 600, positionY: 400, data: {} },
        ],
        edges: [
          { id: 'edge-1', source: 'node-1', target: 'node-2', label: 'WSS' },
          { id: 'edge-2', source: 'node-1', target: 'node-3', label: 'WSS' },
          { id: 'edge-3', source: 'node-2', target: 'node-4', label: 'Read/Write' },
      ...
      },
      {
        ...
        description: 'Social media image sharing platform with CDNs, Timeline generation, and Graph databases.',
        category: 'Social Media',
        nodes: [
          { id: 'node-1', type: 'cdn', label: 'Image CDN', positionX: 100, positionY: 100, data: {} },
          { id: 'node-2', type: 'load-balancer', label: 'ALB', positionX: 300, positionY: 200, data: {} },
          { id: 'node-3', type: 'microservice', label: 'Timeline Service', positionX: 550, positionY: 150, data: {} },
          { id: 'node-4', type: 'microservice', label: 'Upload Service', positionX: 550, positionY: 300, data: {} },
          { id: 'node-5', type: 'postgresql', label: 'PostgreSQL DB', positionX: 800, positionY: 150, data: {} },
          { id: 'node-6', type: 'redis', label: 'Redis Cache', positionX: 800, positionY: 50, data: {} },
          { id: 'node-7', type: 'object-storage', label: 'S3 Image Storage', positionX: 800, positionY: 300, data: {} },
        ],
        edges: [
          { id: 'edge-1', source: 'node-1', target: 'node-2', label: 'HTTPS' },
          { id: 'edge-2', source: 'node-2', target: 'node-3', label: 'TCP' },
